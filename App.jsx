...
const EXAM_DATA = [
  { id: 'general', subject: 'General Strategy', color: 'bg-slate-500', type: 'Meta' },
  {
    ...
    internal: 39.5, needed: 0.5, status: 'PASS SECURED', color: 'bg-green-500', type: 'Regular',
  ...
  },
  {
    ...
    internal: 45, needed: 0, status: 'PRE-EXAM PASS', color: 'bg-emerald-600', type: 'Regular',
  ...
  },
  {
    ...
    internal: 19, needed: 21, status: 'CRITICAL FOCUS', color: 'bg-red-500', type: 'Regular',
  ...
  },
  {
    ...
    internal: 32, needed: 8, status: 'STUDY HARD', color: 'bg-orange-500', type: 'Regular',
