...
const EXAM_DATA = [
  { id: 'earth', subject: 'Earth and Environment', date: '2026-05-19', time: '10:00 AM', status: 'PASS SECURED', color: 'bg-green-500', breakdown: [{ name: 'Midterm', max: 20, score: 16 }] },
  { id: 'pom', subject: 'Principles of Management', date: '2026-05-20', time: '10:00 AM', status: 'PRE-EXAM PASS', color: 'bg-emerald-600', breakdown: [{ name: 'Project', max: 50, score: 30 }] },
  { id: 'macro', subject: 'Macroeconomics', date: '2026-05-21', time: '10:00 AM', status: 'CRITICAL FOCUS', color: 'bg-red-500', breakdown: [{ name: 'Midterm', max: 30, score: 14 }] },
  { id: 'research', subject: 'Research Techniques', date: '2026-05-22', time: '10:00 AM', status: 'STUDY HARD', color: 'bg-orange-500', breakdown: [{ name: 'Quiz', max: 10, score: 7 }] },
  { id: 'finance', subject: 'Corporate Finance', date: '2026-05-23', time: '10:00 AM', status: 'STUDY HARD', color: 'bg-yellow-500', breakdown: [{ name: 'Midterm', max: 20, score: 5 }] },
  { id: 'tools', subject: 'Computational Tools', date: '2026-05-25', time: '10:00 AM', status: 'PRE-EXAM PASS', color: 'bg-blue-500', breakdown: [{ name: 'Project', max: 30, score: 25 }] },
  { id: 'stats', subject: 'Intro to Statistics (Supply)', date: '2026-05-25', time: '03:00 PM', status: 'CRITICAL FOCUS', color: 'bg-red-500', breakdown: [{ name: 'Supply', max: 50, score: 0 }] },
  { id: 'micro', subject: 'Microeconomics (Supply)', date: '2026-05-27', time: '03:00 PM', status: 'CRITICAL FOCUS', color: 'bg-red-500', breakdown: [{ name: 'Supply', max: 50, score: 0 }] }
];
